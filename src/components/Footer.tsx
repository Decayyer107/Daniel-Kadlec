...
export default function Footer() {
    ...
    return (
        <footer className="section bg-gray-200 dark:bg-[#0C0C0E] border-2 shadow-xl border-gray-300 dark:border-gray-900 w-full h-72 rounded-[24px] mb-8 flex justify-center items-center flex-col gap-6 transition-all duration-500">
